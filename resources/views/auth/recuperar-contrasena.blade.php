  ...
  <div class="container-fluid h-custom">
    <div class="row d-flex justify-content-center align-items-center h-100">
      ...
      <div class="col-12 col-md-7 col-lg-6 col-xl-4 px-4 px-md-3 py-4 py-md-0">
        ...
        <p class="text-muted mb-4">Ingresa tu correo electrónico para recuperar tu contraseña.</p>
        ...
        <form action="{{ route('recuperar.verificar') }}" method="POST">
          ...
          <div class="text-center text-md-start mt-4 pt-2">
            <button type="submit" class="btn btn-primary btn-lg w-100 w-md-auto" style="padding-left: 2.5rem; padding-right: 2.5rem;">
              Continuar
            </button>
            <p class="small fw-bold mt-3 pt-1 mb-0">
              <a href="{{ route('login') }}" class="link-danger">Volver al Login</a>
            </p>
          </div>
        </form>
      </div>
